						...
						<div class="mu-about-area">
                            ...
                            <div class="col-md-12">
                                <div class="mu-title">
                                    ...
                                    <img src="{{ asset('assets/images/pix/pix.webp') }}" style="margin-top: -20px"
                                        alt="Enduro do Cerrado" /><br>
                                    <a class="mu-primary-btn" href="https://contate.me/endurodocerrado"
                                        target="_blank">Enviar Comprovante <span
									...
									<div class="mu-about-left">
                                        ...
                                        <div class="mu-single-team">
                                            <div class="mu-single-team-content">
                                                ...
                                                <p>1 kit ( Pilotos inscritos receberão o número de identificação para a
                                                    moto, 1 pulseira que lhe dará direito a socorro, a almoço, e ao
                                                    final e o troféu de participação).</p>
                                                <ul class="mu-team-social">
                                                    <li><a href="https://contate.me/endurodocerrado" target="_blank"><i
                                    ...
                                    <div class="col-md-12">
                                        <div class="mu-single-team">
                                            <div class="mu-single-team-content">
                                                ...
                                                <span>Informações</span>
                                                <p>1 kit ( Pilotos inscritos receberão o número de identificação para o
                                                    quadríciculo, 2 pulseira que lhe dará direito a socorro, a almoço, e
                                                    ao final e o troféu de participação).</p>
                                                <ul class="mu-team-social">
                                                    <li><a href="https://contate.me/endurodocerrado" target="_blank"><i
                                                                class="fa fa-whatsapp"></i></a></li>
                                                    <li><b>Em caso dúvida fale conosco.</b></li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mu-single-team">
                                            <div class="mu-single-team-content">
                                                ...
                                                <span>Informações</span>
                                                <p>1 kit (O Piloto inscrito receberá um número de identificação da UTV,
                                                    Regulamento do Evento, 2 pulseira que lhe dará direito a socorro, a
                                                    almoço, e ao final e o troféu de participação).</p>
                                                <ul class="mu-team-social">
                                                    <li><a href="https://contate.me/endurodocerrado" target="_blank"><i
                                                                class="fa fa-whatsapp"></i></a></li>
                                                    <li><b>Em caso dúvida fale conosco.</b></li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mu-single-team">
                                            <div class="mu-single-team-content">
                                                ...
                                                <span>Informações</span>
                                                <p>1 kit ( O Piloto inscrito receberá um número de identificação do
                                                    carro, Regulamento do Evento, 4 pulseira que lhe dará direito a
                                                    socorro, a almoço, e ao final e o troféu de participação).</p>
                                                <ul class="mu-team-social">
                                                    <li><a href="https://contate.me/endurodocerrado" target="_blank"><i
                                                                class="fa fa-whatsapp"></i></a></li>
                                                    <li><b>Em caso dúvida fale conosco.</b></li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mu-single-team">
                                            <div class="mu-single-team-content">
                                                <h3>Acompanhante</h3>
                                                <span>Informações</span>
                                                <p>Caso tenho o desejo de trazer consigo um acompanhante será combrado
                                                    uma taxa de 30 reais.</p>
                                                <ul class="mu-team-social">
                                                    <li><a href="https://contate.me/endurodocerrado" target="_blank"><i
                                                                class="fa fa-whatsapp"></i></a></li>
                                                    <li><b>Em caso dúvida fale conosco.</b></li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Nome Piloto" name="nome" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Tipo Sanguíneo" name="sangue" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <select name="veiculo" class="form-control">
                                                            ...
                                                            <option value="Quaddriciculo">Quadriciculo - R$ 100
                                                            </option>
